...
async function seedFood() {
  ...
  console.log(
    `✅ Food seeding complete: ${created} created, ${skipped} skipped`,
  );
...
async function seedExercises() {
  ...
  console.log(
    `✅ Exercise seeding complete: ${created} created, ${skipped} skipped`,
  );
  return { created, skipped };
}
...
async function main() {
  ...
  try {
    ...
    console.log(
      `🍎 Food Items:     ${foodStats.created} created, ${foodStats.skipped} skipped`,
    );
    console.log(
      `💪 Exercises:      ${exerciseStats.created} created, ${exerciseStats.skipped} skipped`,
    );
    console.log(
      `📈 Total Created:  ${foodStats.created + exerciseStats.created}`,
    );
    console.log(
      `⏭️  Total Skipped:  ${foodStats.skipped + exerciseStats.skipped}`,
    );
    console.log("=".repeat(50));
