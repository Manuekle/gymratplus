if (!self.define) {
  ...
  self.define = (a, i) => {
    ...
    let p = {};
    const c = (s) => e(s, n),
      u = { module: { uri: n }, exports: p, require: c };
    t[n] = Promise.all(a.map((s) => u[s] || c(s))).then((s) => (i(...s), p));
  };
}
  ...
  (importScripts("/custom-sw.js"),
      ...
      [
        {
          ...
          revision: "tFxDsRp_TpuVm8L0-1v4N",
        },
        {
        ...
        {
          url: "/_next/static/chunks/app/dashboard/notifications/page-c69d402cd12dd95c.js",
          revision: "tFxDsRp_TpuVm8L0-1v4N",
        },
        {
        ...
        {
          url: "/_next/static/chunks/app/layout-b5574a91dc1eb09a.js",
          revision: "tFxDsRp_TpuVm8L0-1v4N",
        },
        {
        ...
        {
          url: "/_next/static/tFxDsRp_TpuVm8L0-1v4N/_buildManifest.js",
          revision: "681470f08a2fbcd00d4b658603632fb8",
        },
        {
          url: "/_next/static/tFxDsRp_TpuVm8L0-1v4N/_ssgManifest.js",
    ...
    s.registerRoute(
      function (s) {
        ...
        return (
          "1" === t.headers.get("RSC") &&
          "1" === t.headers.get("Next-Router-Prefetch") &&
          a &&
          !e.startsWith("/api/")
        );
      },
    ...
    s.registerRoute(
      function (s) {
        var t = s.request,
          e = s.url.pathname,
          a = s.sameOrigin;
        return "1" === t.headers.get("RSC") && a && !e.startsWith("/api/");
      },
      new s.NetworkFirst({
        cacheName: "pages-rsc",
        plugins: [
    ...
    s.registerRoute(
      function (s) {
        var t = s.url.pathname;
        return s.sameOrigin && !t.startsWith("/api/");
      },
      new s.NetworkFirst({
        cacheName: "pages",
        plugins: [
