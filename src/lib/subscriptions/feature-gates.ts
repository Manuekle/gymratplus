 ...
 */
export function hasAccess(userTier: string, requiredTier: SubscriptionTier): boolean {
 ...
 */
export function canAccessFeature(userTier: string, featureName: FeatureName): boolean {
