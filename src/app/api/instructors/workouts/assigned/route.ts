...
export async function GET() {
  console.log('=== Iniciando solicitud GET a /api/instructors/workouts/assigned ===');
  ...
  try {
    ...
    let errorMessage = 'Error interno del servidor al obtener las rutinas asignadas';
    ...
    console.log('=== Finalizando solicitud GET a /api/instructors/workouts/assigned ===');
  }
}
