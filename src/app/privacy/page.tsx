          ...
          <div className="space-y-12">
            ...
            <div className="space-y-10 text-zinc-700 dark:text-zinc-300">
              <section>
                ...
                <ul className="space-y-2 ml-6">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Datos de fitness y salud (peso, altura, objetivos)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-zinc-400 dark:text-zinc-600 mt-1">
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed">
                  No vendemos tu información personal. Compartimos datos solo
                  cuando:
                </p>
                <ul className="space-y-2 ml-6">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Es necesario para proporcionar el servicio (ej. con tu
                      entrenador)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
