            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Send a transactional email via Resend.</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-muted/50">
                    ...
                    <CardContent className="text-sm text-muted-foreground space-y-2">
                        <p>
                            • Use this form to send important announcements, password resets manually, or direct communications.
                        </p>
                        <p>
                            • The email will be sent from the configured system address (e.g., no-reply@gymratplus.com).
                        </p>
                        <p>
                            • HTML content is supported in the message body for basic formatting.
                        </p>
                    </CardContent>
                </Card>
            </div>
