...
import { DumbbellIcon, UserGroupIcon, Activity01Icon, Money03Icon } from "@hugeicons/core-free-icons";
import { HugeiconsIcon } from "@hugeicons/react";

import { OverviewCharts } from "./_components/overview-charts";

export default async function AdminDashboardPage() {
    const { usersCount, exercisesCount, activeSessionsCount, totalRevenue, analyticsData } = await getAdminStats();
            ...
            <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <HugeiconsIcon icon={DumbbellIcon} className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Workouts in progress</p>
                    </CardContent>
                </Card>
            </div>
