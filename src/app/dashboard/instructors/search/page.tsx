...
export default function InstructorSearchPage() {
  ...
  const handleRequestInstructor = useCallback(async (instructorProfileId?: string) => {
    ...
    try {
      ...
      toast.success("Solicitud enviada", { description: "Tu solicitud ha sido enviada al instructor. ¡Pronto se pondrá en contacto contigo!" });
    } catch (error: unknown) {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-semibold tracking-heading mb-6">Buscar Instructor</h1>
                ...
                >
                  ...
                  <div className="px-0 pb-1 pt-0 mt-auto">
                    <Button 
                      ...
                      disabled={requestingInstructorId === instructor.instructorProfile?.id}
                    >
