                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="space-y-10 text-zinc-700 dark:text-zinc-300">
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">1. Aceptación de Términos</h2>
                                <p className="leading-relaxed">
                                    Al acceder y usar GymRat+, aceptas estar sujeto a estos Términos de Servicio y todas las leyes y regulaciones aplicables. Si no estás de acuerdo con alguno de estos términos, no uses nuestro servicio.
                                </p>
                            </section>

                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">2. Descripción del Servicio</h2>
                                <p className="mb-4 leading-relaxed">
                                    GymRat+ es una plataforma que conecta entrenadores y atletas para proporcionar:
                                </p>
                                <ul className="space-y-2 ml-6">
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-zinc-400 dark:text-zinc-600 mt-1">•</span>
                                        <span>Herramientas de comunicación entre entrenadores y clientes</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-zinc-400 dark:text-zinc-600 mt-1">•</span>
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">3. Registro y Cuenta</h2>
                                <p className="mb-4 leading-relaxed">
                                ...
                                <ul className="space-y-2 ml-6">
                                    <li className="flex items-start gap-2">
                                        <span className="text-zinc-400 dark:text-zinc-600 mt-1">•</span>
                                        <span>Ser mayor de 18 años o tener consentimiento parental</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-zinc-400 dark:text-zinc-600 mt-1">•</span>
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">4. Uso Aceptable</h2>
                                <p className="mb-4 leading-relaxed">
                                    No está permitido:
                                </p>
                                <ul className="space-y-2 ml-6">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">5. Suscripciones y Pagos</h2>
                                <p className="leading-relaxed">
                                    Las suscripciones se renuevan automáticamente. Puedes cancelar en cualquier momento desde tu perfil. Los reembolsos se procesan según nuestra política de reembolsos de 30 días.
                                </p>
                            </section>

                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">6. Limitación de Responsabilidad</h2>
                                <p className="leading-relaxed">
                                    GymRat+ proporciona herramientas de fitness, pero no sustituye el consejo médico profesional. Consulta con un profesional de la salud antes de comenzar cualquier programa de ejercicio o dieta.
                                </p>
                            </section>

                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">7. Modificaciones</h2>
                                <p className="leading-relaxed">
                            ...
                            <section className="pt-8 border-t border-zinc-300 dark:border-zinc-700">
                                <h2 className="text-2xl font-semibold mb-4 text-zinc-900 dark:text-zinc-100">8. Contacto</h2>
