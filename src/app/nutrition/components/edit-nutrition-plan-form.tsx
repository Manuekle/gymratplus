...
export function EditNutritionPlanForm({ plan }: { plan: NutritionPlan }) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Actualiza la información básica de tu plan de nutrición
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button className="text-xs" type="submit" disabled={isSubmitting}>
