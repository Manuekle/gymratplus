                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2">
                                    <Button
                                        ...
                                        size="sm"
                                    >
                                        {isPaused ? <HugeiconsIcon icon={PlayIcon} size={18} className="mr-2" /> : <HugeiconsIcon icon={PauseIcon} size={18} className="mr-2" />}
                                        {isPaused ? "Reanudar" : "Pausar"}
                                    </Button>
                                    <Button
                                        onClick={(e) => { e.stopPropagation(); goToActive(); }}
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="w-8 h-8 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                                        <HugeiconsIcon icon={ArrowUp01Icon} size={16} className="text-zinc-500" />
                                    </div>
                                </div>
                            </motion.div>
                        )}
