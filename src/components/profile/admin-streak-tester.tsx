    ...
    return (
        <Card className="border-orange-200 dark:border-orange-900 bg-orange-50/50 dark:bg-orange-950/20">
            <CardHeader>
                ...
                <CardDescription>
                    Herramientas para probar las animaciones de racha. Solo visible para el admin configurado.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    >
                        <HugeiconsIcon icon={FireIcon} className="h-4 w-4 mr-2 text-indigo-500" />
                        Test Racha Día 1
                    </Button>
                    ...
                    <Button
                        ...
                        className="justify-start"
                    >
                        <HugeiconsIcon icon={FireIcon} className="h-4 w-4 mr-2 text-cyan-500" />
                        Test Racha Día 5
                    </Button>
                    ...
                    <Button
                        ...
                        className="justify-start"
                    >
                        <HugeiconsIcon icon={FireIcon} className="h-4 w-4 mr-2 text-lime-500" />
                    ...
                    <Button
                        ...
                        className="justify-start"
                    >
                        <HugeiconsIcon icon={StarIcon} className="h-4 w-4 mr-2 text-yellow-500" />
                        Test Racha 100 Días
                    </Button>
